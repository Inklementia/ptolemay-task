...
class MyEdgeInsets {
  ...
  static const all14 = EdgeInsets.all(14);
  ...
  static const left14 = EdgeInsets.only(left: 14);
  ...
  static const top14 = EdgeInsets.only(top: 14);
  ...
  static const h12v18 = EdgeInsets.symmetric(
    horizontal: 12,
    vertical: 18,
  );
  ...
  /// h16v
  ///
  static const h16v4 = EdgeInsets.symmetric(
    horizontal: 16,
    vertical: 4,
  );
  ...
  static const h22v18 = EdgeInsets.symmetric(
    horizontal: 22,
    vertical: 18,
  );
